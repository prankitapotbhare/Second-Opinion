  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col h-full">
      ...
      <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
        ...
        />
        {/* 'featured' property might not exist in consolidated data, handle optionally */}
        {doctor.featured && (
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col">
        <h3 className="font-bold text-lg sm:text-xl text-gray-800 mb-1">{doctor.name || 'Dr. Anonymous'}</h3> {/* Use name */}
        ...
        <div className="flex flex-wrap gap-1 mb-2">
          ...
          {/* Optionally display qualification if degree is missing */}
        ...
        <p className="text-gray-600 text-sm mb-1">{doctor.degree || doctor.qualification || 'N/A'}</p>
        ...
        {/* Rating - Use rating and reviewCount */}
        {doctor.rating && (
        ...
        {/* Action Buttons - Use doctor.id */}
        <div className="mt-auto pt-4">
          {mounted ? (
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3">
              <Link href={`/user/doctors/${doctor.id}`} className="col-span-1"> {/* Use id */}
              ...
              <Link href={`/user/appointment/booking?doctorId=${doctor.id}`} className="col-span-1">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3">
                <div className="col-span-1 h-9 bg-gray-200 rounded-lg animate-pulse"></div>
                <div className="col-span-1 h-9 bg-gray-300 rounded-lg animate-pulse"></div>
            </div>
          )}
        </div>
      </div>

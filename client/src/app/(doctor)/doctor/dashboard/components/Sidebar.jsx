...
//         }`}
//       >
//         <div className={`flex flex-col h-screen ${isCollapsed ? 'w-20' : 'w-72'} bg-white text-black shadow-xl overflow-y-auto transition-all duration-300`}>
...
//                   </p>
//                   <p className="text-xs text-black">{user?.specialization || 'Physician'}</p>
//                 </div>
//               )}
//             </div>
//           </div>
...
//                         : "text-black hover:bg-teal-300 hover:text-black"
...
//               className={`group flex items-center w-full px-4 py-3 text-black bg-white hover:bg-red-50 rounded-lg transition-all duration-300 shadow-sm border border-blue-200 hover:border-red-200 ${isCollapsed ? 'justify-center' : ''}`}
//             >
            ...
            <div className={`mt-6 flex ${isCollapsed ? 'flex-col items-center' : 'items-center'} border-y border-blue-200 py-6`}>
              ...
              {!isCollapsed && (
                <div className="ml-3 overflow-hidden">
                  ...
                  <p className="text-xs text-[#0F172A]">{user?.specialization || 'Physician'}</p>
                </div>
              )}
            </div>
          </div>

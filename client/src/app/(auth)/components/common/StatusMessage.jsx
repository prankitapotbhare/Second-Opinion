...
const StatusMessage = ({
  ...
  const renderButton = (buttonConfig) => {
    ...
    const { text, href, onClick, primary = false } = buttonConfig;
    
    const buttonClasses = primary 
      ? "w-full py-3 px-4 mb-2 bg-black text-white font-medium rounded-md hover:bg-gray-800 transition-colors"
      : "w-full py-3 px-4 border border-gray-300 text-gray-700 font-medium rounded-md hover:bg-gray-50 transition-colors";
